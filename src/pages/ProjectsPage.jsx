            ...
            {selectedProject.previewImage && (
              <div className="relative">
                ...
                <a
                  ...
                  className="absolute bottom-8 sm:bottom-9 md:bottom-8 lg:bottom-10 right-4 sm:right-7 text-white text-[7px] sm:text-[8px] lg:text-[12px] bg-gradient-to-r from-purple-500 to-indigo-500 px-1 py-1 rounded-lg hover:from-orange-500 hover:to-yellow-400"
                >
                  Access Project
                </a>
              </div>
